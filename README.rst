...
.. image:: https://img.shields.io/packagist/v/o3-shop/testing-library.svg?maxAge=3600
    :target: https://packagist.org/packages/o3-shop/testing-library

The O3-Shop testing library can be used to test O3-Shop with
existing or new Unit, Integration, Mink or QUnit tests. Furthermore, it
can also be very helpful to developers who create a module for the O3-Shop.
...
4. New PHPUnit window pops up. Check "Default bootstrap file" checkbox
   ...
   Path to bootstrap:
   {source}/vendor/o3-shop/testing-library/bootstrap.php
...
Testing library branch names follow the O3-Shop component branch names. Which means that branch names
do not follow testing library version numbers, but represent the target version of the O3-Shop compilation.
For example:
